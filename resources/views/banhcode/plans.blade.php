...
::-webkit-scrollbar-thumb {
    ...
    <section class="about-section text-center" id="about">
        <div class="container px-4 px-lg-5">
            ...
            <img class="img-fluid" data-aos="zoom-in" data-aos-delay="200" src="{{ asset("/banhcode/assets/img/Banh_Code-(no-background).png") }}" alt="..." />
        </div>
        ...
        <div class="card-group vgr-cards">
            <div class="card"> 
                ...
                <div class="card-img-body bg-gradient">
                    <img class="card-img" src="{{ asset("/banhcode/assets/img/javascript.png") }}" alt="Card image cap" style="width: 100%px;">
                </div>
                <div class="card-body">
                    ...
                    <h4 class="card-text text-center m-3" style="font-size: 20px;">the users will be taught all the
                        ...
                        a good rating</h4>
                    <a href="{{ url("transaction_js.php") }}" class="btn btn-outline-primary" style="margin-left: 110px;">Select</a>
                </div>
            </div>
            <div class="card">
                <div class="card-img-body">
                    <img class="card-img" src="{{ asset("/banhcode/assets/img/logo-python.png") }}" alt="Card image cap">
                </div>
                <div class="card-body">
                    ...
                    <a href="{{ url("transaction_py.php") }}" class="btn btn-outline-primary" style="margin-left: 108px;">Select</a>
                </div>
            </div>
            <div class="card">
                <div class="card-img-body">
                    <img class="card-img" src="{{ asset("/banhcode/assets/img/php.png") }}" alt="Card image cap">
                </div>
                <div class="card-body">
                    ...
                    <a href="{{ url("transaction_php.php") }}" class="btn btn-outline-primary" style="margin-left: 110px;">Select</a>
                </div>
            </div>
        </div>
    </div>
