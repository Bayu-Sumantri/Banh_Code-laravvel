                          ...
                          <ul class="nav nav-treeview">
                              ...
                              <li class="nav-item">
                                  <a href="{{ route('create_tugas') }}" class="nav-link">
                                      <i class="fas fa-money-check nav-icon"></i>
                                      <p>Create Tugas (Staff) </p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="{{ route('tugas_staff_show') }}" class="nav-link ">
                                      <i class="fas fa-users nav-icon"></i>
                                      <p>Show Tugas (Staff)</p>
                                  </a>
                              </li>
                              <li class="nav-item">
                                  <a href="{{ route('user_active_kelas') }}" class="nav-link ">
                                      <i class="fas fa-users nav-icon"></i>
                                      <p>User Active (Staff)</p>
                                  </a>
                              </li>
